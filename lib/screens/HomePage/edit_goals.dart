                ...
                child: GestureDetector(
                  onTap: ()async{
                    if(_title.text.isEmpty){
                      ...
                      try{
                        await Users.updateGoals(Title: updateTitle,Description: updateDescription,docId: widget.currentId);
                        ScaffoldMessenger.of(context).showSnackBar(
                            SnackBar(
                              content:Container(
                                height: 60,
                                ...
                                child: Padding(
                                  ...
                                  child: Column(
                                    ...
                                    children: [
                                      ...
                                      SizedBox(height: 5,),
                                      Text("Updated Succesfully",style: TextStyle(color: ConstColors.primaryColor,fontFamily: 'Book',fontWeight: FontWeight.w500
                                      ),),
                                    ],
                                  ),
                                ),
