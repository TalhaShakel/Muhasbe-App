...
class EditMRoutine extends StatefulWidget {
  ...
  @override
  State<EditMRoutine> createState() => _EditMRoutineState();
}

class _EditMRoutineState extends State<EditMRoutine> {
      ...
      body: Container(
        ...
        child: Column(
          children: [
            ...
            Padding(
              padding: const EdgeInsets.only(left: 27, right: 27, top: 50),
              child: Container(
                width: double.infinity,
                height: 40,
                  ...
                  child: GestureDetector(
                    onTap: ()async{
                      if(_title.text.isEmpty){
                        ...
                        try{
                          await Users.updateM_routine(Title: updateTitle, docId: widget.currentId);
