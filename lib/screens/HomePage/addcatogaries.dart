...
class AddCatogaries extends StatefulWidget {
  const AddCatogaries({Key? key}) : super(key: key);
  @override
  State<AddCatogaries> createState() => _AddCatogariesState();
}

class _AddCatogariesState extends State<AddCatogaries> {
  String gettitle = "";
