...
class DeleteGoals extends StatefulWidget {
  const DeleteGoals({Key? key}) : super(key: key);

  @override
  State<DeleteGoals> createState() => _DeleteGoalsState();
}

class _DeleteGoalsState extends State<DeleteGoals> {
                    ...
                    child: Container(
                      ...
                      child: TextFormField(
                        ...
                        decoration: InputDecoration(
                          ...
                          hintStyle: AppTextTheme.hintTxt,
                          contentPadding: EdgeInsets.only(bottom: 0,top: 10, left: 10),
                          border: InputBorder.none,
                        ),
                        // validator: (value) {
                        //   Validator.validateField(value: value!);
                ...
                child: GestureDetector(
                  onTap: ()async{
                    if(_title.text.isEmpty){
                              ...
                              child: Padding(
                                ...
                                child: Column(
                                  ...
                                  children: [
                                    ...
                                    SizedBox(height: 5,),
                                    Text("Title should not be empty",style: TextStyle(color: ConstColors.primaryColor,fontFamily: 'Book',fontWeight: FontWeight.w500
                                    ),),
                                  ],
                                ),
                              ),
                              ...
                              child: Padding(
                                ...
                                child: Column(
                                  ...
                                  children: [
                                    ...
                                    SizedBox(height: 5,),
                                    Text("Description should not be empty",style: TextStyle(color: ConstColors.primaryColor,fontFamily: 'Book',fontWeight: FontWeight.w500
                                    ),),
                                  ],
                                ),
                              ),
                      ...
                      try{
                        // await Users.addGoals(Title: gettitle, Description: getdescription);
                        ScaffoldMessenger.of(context).showSnackBar(
                            SnackBar(
                              content:Container(
                                height: 60,
                                ...
                                child: Padding(
                                  ...
                                  child: Column(
                                    ...
                                    children: [
                                      ...
                                      SizedBox(height: 5,),
                                      Text("Added Succesfully",style: TextStyle(color: ConstColors.primaryColor,fontFamily: 'Book',fontWeight: FontWeight.w500
                                      ),),
                                    ],
                                  ),
                                ),
