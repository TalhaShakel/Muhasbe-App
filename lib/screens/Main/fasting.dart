...
class _FastingState extends State<Fasting> {
  ...
  List dropDownlistData2 = [
    {"title": "Muharram", "value": "1"},
    {"title": "Safar", "value": "1"},
    {"title": "Rabi ul Awal", "value": "1"},
        ...
        child: SingleChildScrollView(
          child: Column(
            children: [
              ...
              Text(
                "“Fasting for the purpose abcdef”",
                style: TextStyle(
                    fontFamily: 'Trial',
                    fontSize: 12,
                    color: Color(0xff828282)),
                  ...
                  child: Column(
                    children: [
                      ...
                      GestureDetector(
                        // onTap: (){
                        //   Navigator.push(
                        //   context, MaterialPageRoute(builder: (context)=>DailyReflection()));
                        // },
                        child: Padding(
                          padding: const EdgeInsets.only(
