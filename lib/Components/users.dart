...
class Users {
  ...
  static Future<void> addGoals({
    ...
    collection('users').
    doc(FirebaseAuth.instance.currentUser!.uid).collection('Goals').doc();
  ...
  static Future<void> updateGoals({
    ...
    DocumentReference documentReference = FirebaseFirestore.instance.
    collection('users').doc(FirebaseAuth.instance.currentUser!.uid).collection('Goals').doc(docId);
    Map<String,dynamic> data = <String,dynamic>{
      "title":Title,
      "description":Description,
    };
  ...
  static Stream<QuerySnapshot> readGoals(){
    ...
    collection('users').doc(FirebaseAuth.instance.currentUser!.uid).collection('Goals');
  ...
  static Future<void> updateCatogaries({
    ...
    DocumentReference documentReference = FirebaseFirestore.instance.
    collection('users').doc(FirebaseAuth.instance.currentUser!.uid).collection('Categories').doc(docId);
    Map<String,dynamic> data = <String,dynamic>{
      "title":Title,
      "description":Description,
    };
  ...
  static Stream<QuerySnapshot> readCatogaries(){
    CollectionReference notesItemcollection = FirebaseFirestore.instance.
    collection('users').doc(FirebaseAuth.instance.currentUser!.uid).collection('Categories');
    return notesItemcollection.snapshots();
  }
  static Future<void> addM_routine({
    ...
    DocumentReference documentReference = FirebaseFirestore.instance.
    collection('users').
    doc(FirebaseAuth.instance.currentUser!.uid).collection('Morning Routine').doc();
  ...
  static Future<void> updateM_routine({
    ...
    DocumentReference documentReference = FirebaseFirestore.instance.
    collection('users').doc(FirebaseAuth.instance.currentUser!.uid).collection('Morning Routine').doc(docId);
    Map<String,dynamic> data = <String,dynamic>{
      "title":Title,
    };
    await documentReference.set(data).whenComplete(() => print('note item updated in Database')).catchError((e) =>print(e));
  ...
  static Stream<QuerySnapshot> readM_routine(){
    CollectionReference notesItemcollection = FirebaseFirestore.instance.
    collection('users').doc(FirebaseAuth.instance.currentUser!.uid).collection('Morning Routine');
    return notesItemcollection.snapshots();
  }
  static Future<void> addH_Habits({
    ...
    DocumentReference documentReference = FirebaseFirestore.instance.
    collection('users').
    doc(FirebaseAuth.instance.currentUser!.uid).collection('Healthy Habits').doc();
  ...
  static Future<void> updateH_Habits({
    ...
    DocumentReference documentReference = FirebaseFirestore.instance.
    collection('users').doc(FirebaseAuth.instance.currentUser!.uid).collection('Healthy Habits').doc(docId);
    Map<String,dynamic> data = <String,dynamic>{
      "title":Title,
    };
    await documentReference.set(data).whenComplete(() => print('note item updated in Database')).catchError((e) =>print(e));
  ...
  static Stream<QuerySnapshot> readH_Habits(){
    CollectionReference notesItemcollection = FirebaseFirestore.instance.
    collection('users').doc(FirebaseAuth.instance.currentUser!.uid).collection('Healthy Habits');
    return notesItemcollection.snapshots();
  }
